    ...
    public partial class LoginForm : CommonLoginForm
    {
        ...
        public override void Login()
        {
            ...
            if (SAPDataService.Login(User, Password))
            {
                ...
                InventoryMainFormNew mainForm = new InventoryMainFormNew();
                mainForm.ShowDialog();
            }
            else
            {
        ...
        private void LoginForm_Load(object sender, EventArgs e)
        {
            ...
            Thread thread = new Thread(new ThreadStart(() => {
                ...
                SysConfig.DeviceInfo = SAPDataService.GetHLANo(SysConfig.LGNUM, SysConfig.DeviceNO, "01B");

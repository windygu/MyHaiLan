...
namespace HLACommonView.Views
{
    public class CheckedComboBox : ComboBox {
        ...
        internal class Dropdown : Form {
            ...
            internal class CustomCheckedListBox : CheckedListBox {
                ...
                public CustomCheckedListBox() : base() {
                    ...
                    this.Font = new Font("ËÎÌו", 15, FontStyle.Bold);
            ...
            public List<string> GetCheckedItemsStringList()
            {
                List<string> re = new List<string>();

                for (int i = 0; i < cclb.CheckedItems.Count; i++)
                {
                    re.Add(cclb.GetItemText(cclb.CheckedItems[i]));
                }
        ...
        {
            return dropdown.GetCheckedItemsStringList();
        }

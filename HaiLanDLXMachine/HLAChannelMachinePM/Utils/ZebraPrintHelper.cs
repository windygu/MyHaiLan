...
namespace HLAChannelMachine.Utils
{
    ...
    public static class ZebraPrintHelper
    {
        ...
        public static extern bool StartDocPrinter(IntPtr intptrPrinter, Int32 level, [In, MarshalAs(UnmanagedType.LPStruct)] ZebraDocInfo docInfo);
        ...
        private static bool SendBytesToPrinter(string printerName, IntPtr intptrBytes, Int32 count)
        {
            ...
            ZebraDocInfo docInfo = new ZebraDocInfo();
            bool bSuccess = false;
